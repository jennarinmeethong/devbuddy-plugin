...
**Status: IN PROGRESS.** The tool, the set and the Ollama numbers are done. The LM Studio run waits
on its server being started, and the with-C1 run waits on C1.
