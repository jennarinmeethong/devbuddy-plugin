...
### C6 — Replacing MinIO
**Status: IN PROGRESS.** Planned at the owner's word (`info.md`, 2026-09-26). **The SeaweedFS
spike is done and passed** (`tools/spikes/c6-seaweedfs/`, and the log). Nothing is built into the
