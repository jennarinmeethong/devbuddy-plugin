...
| SB-29 | Releases produce an SBOM; artifact and image origins and versions are verifiable. | Build | SBOM produced and attached per release; image digest recorded. | Signing and attestation are not in v1 scope; stated, not implied. |
